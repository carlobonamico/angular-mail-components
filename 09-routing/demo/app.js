angular.module("mailApp", ["mail.search","ui.router"]);

angular.module("mailApp").config(['$stateProvider', '$urlRouterProvider',
  function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
      .state('messageList', {
        url: '/messageList',
        templateUrl: 'templates/message-list-view.html',
        // controller: 'AddOrderController'
      })
        
      .state('composeMessage', {
        url: '/composeMessage', 
        templateUrl: 'templates/message-compose-view.html',
...
function MailController(AccountService, MessageService, $state)
{ 
    this.$state = $state;
    ...
    this.closeComposer = function () {
        //TODO go to messageList state
        
        this.$state.go('messageList');
    };
    ...
    this.compose = function (template) {
        ...
        // TODO go to composeMessage state
        this.$state.go('composeMessage');
    };
